...
public interface IAuthRepository
{
    ...
    AuthRefreshTokenRow? GetRefreshTokenByHash(string tokenHash);
    IReadOnlyList<AuthRefreshTokenRow> GetActiveRefreshTokensByUser(Guid userId);
    void RevokeAllUserRefreshTokens(Guid userId, DateTimeOffset revokedAt);
