...
SET practicas_json = E'{json_escaped}'
WHERE agenda_id = 'e09e02b8-fa81-4c21-bcbe-2e0d84a3f7b4';
"""

with open(r'D:\xampp\htdocs\his\VitalFlowHis\db\scripts\update_practicas_block2.sql', 'w', encoding='utf-8') as f:
    f.write(sql)

print(f"SQL generated: {len(sql)} chars")
print(f"First practice: {json.dumps(data[0], ensure_ascii=False)}")
