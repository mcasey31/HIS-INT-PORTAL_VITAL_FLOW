...
import type { ContactoTipo, ContactoUso } from "./usePersonas";
      ...
      {scanModalOpen ? (
        <div className="modal-backdrop" role="dialog" aria-modal="true" aria-label="Escanear DNI">
          <div className="scan-dni-modal">
            <h3>Escanear DNI</h3>
            <p className="scan-dni-help">Ubique el codigo QR del DNI dentro del recuadro y presione Escanear.</p>

            <div className="dni-card-mock">
              <div className="dni-card-text">
                <strong>Documento Nacional de Identidad</strong>
                <span>Frente</span>
              </div>
              <div className="dni-qr-zone">
                <div className="dni-qr-grid" />
              </div>
            </div>
