...
export function useAdmisionController() {
  ...
  return {
    ...
    loadingIdentificacion, setLoadingIdentificacion,
    candidatosPaciente, setCandidatosPaciente,
    pacienteSeleccionado, setPacienteSeleccionado,
    cabeceraExpandida, setCabeceraExpandida,
    financiadoresPaciente, setFinanciadoresPaciente,
    financiadorPlanId, setFinanciadorPlanId,
    elegibilidadManual, setElegibilidadManual,
    financiadorModalOpen, setFinanciadorModalOpen,
    financiadorEditandoId, setFinanciadorEditandoId,
    financiadorFormId, setFinanciadorFormId,
    planFormId, setPlanFormId,
    numeroAfiliadoForm, setNumeroAfiliadoForm,
    financiadorModalError, setFinanciadorModalError,
    financiadorModalInfo, setFinanciadorModalInfo,
    selectores, setSelectores,
    servicioId, setServicioId,
    practicaId, setPracticaId,
    tipoEfector, setTipoEfector,
    ...
    arribandoId, setArribandoId,
    actualizandoEstadoId, setActualizandoEstadoId,
    modoArriboProgramado, setModoArriboProgramado,
    turnosPacienteDia, setTurnosPacienteDia,
    turnoSeleccionadoId, setTurnoSeleccionadoId,
    mostrarFiltrosAvanzados, setMostrarFiltrosAvanzados,
    filtroPaciente, setFiltroPaciente,
    filtroFinanciador, setFiltroFinanciador,
    modalProgramadoOpen, setModalProgramadoOpen,
    pasoModalProgramado, setPasoModalProgramado,
    loadingPacienteProgramado, setLoadingPacienteProgramado,
    modalPracticasOpen, setModalPracticasOpen,
    loadingPracticasModal, setLoadingPracticasModal,
    bloquePracticasNombre, setBloquePracticasNombre,
    practicasDisponiblesModal, setPracticasDisponiblesModal,
    practicasSeleccionadasModal, setPracticasSeleccionadasModal,
    practicasPorTurno, setPracticasPorTurno,
    practicaAEliminar, setPracticaAEliminar,
    modalDemandaOpen, setModalDemandaOpen,
    pasoModalDemanda, setPasoModalDemanda,
    loadingAgendasDemanda, setLoadingAgendasDemanda,
    agendasDemandaHoy, setAgendasDemandaHoy,
    agendaDemandaId, setAgendaDemandaId,
    agendaDemandaDetalle, setAgendaDemandaDetalle,
    bloqueDemandaId, setBloqueDemandaId,
    servicioDemandaId, setServicioDemandaId,
    practicaDemandaId, setPracticaDemandaId,
    turnoOfertaId, setTurnoOfertaId,
    turnoDiscrepancia, setTurnoDiscrepancia,
    modalSinTurnosOpen, setModalSinTurnosOpen,
    error, setError,
    info, setInfo,
    ...
    esEdicionFinanciador, esCombinacionDuplicada,
    numeroAfiliadoValido, puedeGuardarFinanciador,
    requiereElegibilidadManual, elegibilidadCompleta,
    puedeAdmitirPaciente,
    turnosBase, turnosVisibles,
    turnoSeleccionado, turnoSeleccionadoConPaciente,
    puedeConfirmarArriboProgramado, puedeIniciarAdmitirProgramado,
    puedeIniciarAtencionProgramada, puedeFinalizarAtencionProgramada,
    practicasTurnoSeleccionado, puedeGestionarPracticasTurno,
    practicasDemandaDisponibles, agendasDemandaFiltradas,
    agendaDemandaSeleccionada, turnosOfertaDemanda,
    edadPaciente, fechaNacimientoPaciente, iconoSexo,
    resetFinanciadorForm, inicializarCoberturaPaciente,
    onAbrirModalFinanciador, onCerrarModalFinanciador,
    onEditarFinanciador, onFinalizarVigencia, onGuardarFinanciador,
    loadTurnos, onBuscar, onIdentificarPaciente, onConfirmarArribo,
    onFiltrarTurnosPacienteDelDia,
    onAbrirAdmitirProgramadoDesdeTurno, onConfirmarPacienteProgramado,
    ...
    onSolicitarEliminarPractica, onConfirmarEliminarPractica
  };
}
